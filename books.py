...
class bookFrame(tk.Frame):
    def __init__(self, parent):
        ...
        l6.grid(row=6, column=0, columnspan=2, sticky = "EW")

        l7 = tk.Label(self, text = "Your Collection", font = self.titlefont)
        l7.grid(row=1, column=2, columnspan=3, sticky = "EW")

        self.booklist = tk.Listbox(self,width=30, height=20)
        self.booklist.grid(row=7, column=0)

        self.ownBooks = tk.Listbox(self,width=30)
        self.ownBooks.grid(row=3, column=3, rowspan = 10)
